...
public:
  ...
  /**
          ...
          Fügt einen Graphen mit dem GraphController vom Typ t zu dem Window
     hinzu.

          \param name Name des Graphen

          \tparam t Typ des GraphController, der die Punkte im Graphen
     kontrolliert
                    (t muss von StdGraphController erben)

  */
  template <class t> void addGraph(std::string name) {
  ...
  */
  ...
  /**
          ...
          Die Methode ruft den Algorithmus für die Geometrie auf und überträgt
     die
  ...
  */
  ...
  /**
          ...
          Die Mainloop ruft die Methode Window::render auf, die nur 25 mal in
     der Sekunde
          ausgeführt wird und wartet auf einen Tastendruck, um dannach das
     Fenster zu
          schließen.
  */
  void mainloop();
