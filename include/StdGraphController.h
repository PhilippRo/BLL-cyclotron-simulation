...
/**
  ...
  Punktsammelungen.
  Er muss dabei threadsicher und schnell sein. Außerdem muss er auf den
  Speicherverbrauch achten.
  Diese Implementation erlaubt maximal 1000 Werte.
  Sollte dieser Wert überschritten werden, werden die überschüssigen Werte
  gelöscht.
*/
...
protected:
  /**
     ...
     Wert vedoppelt sich nach jedem Löschvorgang. Ein Löschvorgang wird
     aufgerufen,
  ...
  */
  ...
  /**
      ...
      Bei jedem ignorierten Wert wird pointsFiltered um eins erhöht. Wenn
     pointsFiltered
      gleich pointsToFilter sind wird ein Wert aufgenommen und pointsFiltered
     auf 1 gesetzt.
  */
  int pointsFiltered;
...
public:
  ...
  */
  ...
  /**
      ...
      Diese Methode fügt wenn alle Bedingungen erfüllt sind einen Punkt der
     Punktesammlung
      hinzu. Sind die Bedingungen nicht erfüllt wird der Punkte einfach
     ignoriert.
      Diese Methode ist auch für das Löschen der überschüssigen Werte
     verantwortlich.
