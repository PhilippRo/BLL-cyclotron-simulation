...
protected:
  ...
  /// die Frequenz, mit der das Vorzeichen der Spannung am Kondensator geändert
  /// wird
  Double f;
  ...
  /// der Zeitmaßstab legt die Abbildung der simulierten auf der realen Zeit
  /// fest
  float timeScale = 1.0;
...
public:
  ...
  /**	\brief der Destruktor
          ...
          Threads Exceptions werfen kann und es nötig Threads zu beenden, bevor
     sie
          gelöscht werden.
  */
  virtual ~Zyklotron();
  ...
  /**
          ...
          Shutdown setzt das Feld running auf false und beendet die internen
     Threads.
  */
  void shutdown();
  ...
  /**
          ...
          \param paraF Frequenz mit der die Spannung am Kondensator geändert
     wird
  ...
  */
  void configure(Double paraQ, Double paraU, Double paraD, Double paraV0,
  ...
  /**
          ...
          Diese Methode startet das Zykotron und damit die Threads thisThread
     und
          calcThread.
