...
gesucht, die sich aus der obigen Gleichung $s(t)$ ableiten l"asst.
...
\frac{a*t}{c} && = \sqrt{(\frac{s*a}{c^2} + \sqrt{1 + (\frac{v_0}{c})^2})^2 -1} - \frac{v_0}{c} \\
t && = \frac{c}{a} * (\sqrt{(\frac{s*a}{c^2} + \sqrt{1 + (\frac{v_0}{c})^2})^2 -1} - \frac{v_0}{c}) \\
t && = \frac{c}{a} * \sqrt{(\frac{s*a}{c^2} + \sqrt{1 + (\frac{v_0}{c})^2})^2 -1} - \frac{v_0}{a}
\end{eqnarray}
